...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/01 20:45:56 by eel-moun          #+#    #+#             */
/*   Updated: 2022/07/01 21:13:08 by eel-moun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	mouse_move(int x, int y, t_var *var)
{
	...
	{
		var->zoom.x = var->min.x + ((double)x * (var->max.x - var->min.x))
			/ 500;
		var->zoom.y = var->min.y + ((double)y * (var->max.y - var->min.y))
			/ 500;
		clear_and_draw(var);
	}
	return (0);
